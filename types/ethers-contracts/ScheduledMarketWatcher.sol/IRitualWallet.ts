...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IRitualWalletInterface extends Interface {
  ...
  export interface IRitualWallet extends BaseContract {
    
    connect(runner?: ContractRunner | null): IRitualWallet;
    waitForDeployment(): Promise<this>;

    interface: IRitualWalletInterface;
